...
build/memory/heap/heap.o: src/memory/heap/heap.c
	i686-elf-gcc $(INCLUDES) -Isrc/memory/heap $(FLAGS) -std=gnu99 -c src/memory/heap/heap.c -o build/memory/heap/heap.o

build/memory/heap/kheap.o: src/memory/heap/kheap.c
	i686-elf-gcc $(INCLUDES) -Isrc/memory/heap $(FLAGS) -std=gnu99 -c src/memory/heap/kheap.c -o build/memory/heap/kheap.o

build/memory/paging/paging.o: src/memory/paging/paging.c
	i686-elf-gcc $(INCLUDES) -Isrc/memory/paging $(FLAGS) -std=gnu99 -c src/memory/paging/paging.c -o build/memory/paging/paging.o

build/memory/paging/paging.asm.o: src/memory/paging/paging.asm
	nasm -f elf -g src/memory/paging/paging.asm -o build/memory/paging/paging.asm.o

build/disk/disk.o: src/disk/disk.c
	i686-elf-gcc $(INCLUDES) -Isrc/disk $(FLAGS) -std=gnu99 -c src/disk/disk.c -o build/disk/disk.o

build/disk/streamer.o: src/disk/streamer.c
	i686-elf-gcc $(INCLUDES) -Isrc/disk $(FLAGS) -std=gnu99 -c src/disk/streamer.c -o build/disk/streamer.o

build/fs/fat/fat16.o: src/fs/fat/fat16.c
	i686-elf-gcc $(INCLUDES) -Isrc/fs -Isrc/fs/fat $(FLAGS) -std=gnu99 -c src/fs/fat/fat16.c -o build/fs/fat/fat16.o

build/fs/file.o: src/fs/file.c
	i686-elf-gcc $(INCLUDES) -Isrc/fs $(FLAGS) -std=gnu99 -c src/fs/file.c -o build/fs/file.o

build/fs/pparser.o: src/fs/pparser.c
	i686-elf-gcc $(INCLUDES) -Isrc/fs $(FLAGS) -std=gnu99 -c src/fs/pparser.c -o build/fs/pparser.o
